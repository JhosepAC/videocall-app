export const en = {
    ...
    auth: {
        ...
        complete_profile: {
            ...
            avatar_hint: 'JPG, PNG, WebP or GIF. Max 50MB.',
            saving: 'Saving...',
    ...
    room: {
        ...
        guest_join_title: 'You are joining as a guest',
        guest_join_subtitle: 'Configure your devices and enter your name before requesting access.',
        guest_name_label: 'Your name',
        guest_name_placeholder: 'Enter your name',
        guest_name_required: 'Please enter your name',
        guest_name_min: 'Name must be at least 2 characters',
        guest_request_join: 'Request access',
        guest_pending_title: 'Request sent',
        guest_pending_desc: 'Waiting for the host to approve your access request.',
        guest_cancel: 'Cancel request',
        guest_rejected_title: 'Access denied',
        guest_rejected_desc: 'The host has denied your request to join the meeting.',
        guest_try_again: 'Try again',
        join_requests: 'Join Requests',
        guest_warning: 'This person has not signed in with an account. They may not be who they claim to be.',
        guest_approve: 'Approve',
        guest_reject: 'Reject',
        guest_login_title: 'Join MeetMesh!',
        guest_login_desc: 'Create an account or sign in for a personalized experience.',
        guest_sign_in: 'Sign In',
        guest_create_account: 'Create Free Account',
        guest_avatar_label: 'Select avatar (optional)',
        guest_avatar_info: 'If none is selected, your initials will be shown based on your name.',
    },
    ...
    errors: {
        ...
        upload_failed: 'Failed to upload image. Try again.',
        invalid_file_type: 'Invalid file type. Allowed: JPG, PNG, WebP, GIF.',
